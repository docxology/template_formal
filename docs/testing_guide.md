...
`tests/colony/test_colony_experiments_extended.py` — now ten
...
`capped_low_decay_points`, `extreme_positive_control_results`,
`sensed_concentration_cap_dose_response_points`,
`null_model_results_seed7000`), each running hundreds of sequential real
